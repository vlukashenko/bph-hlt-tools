...
def controller(args):
    ...
    if args.run != -1 and args.runmax == None and args.era == None:
        ...
        runs = configuration['eras'][args.era]
    else:
    ...
    if args.test == 'l1rate':
        ...
        test_lumi(omsapi, runs, args.output_path)
    elif args.test == 'runqualitycheck':
        test_bad_runs(omsapi, runs, args.output_path)
